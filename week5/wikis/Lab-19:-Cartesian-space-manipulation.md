In [Lab 7](https://github.com/cse481wi19/cse481wi19/wiki/Lab-7%3A-Controlling-the-arm), we saw how to control the robot's arm by setting the joint angles of the arm.
...
You can find our interface in the course repository in [robot_api/src/robot_api/moveit_goal_builder.py](https://github.com/cse481wi19/cse481wi19/blob/indigo-devel/robot_api/src/robot_api/moveit_goal_builder.py).
...
In `robot_api/arm.py`, add a method to `Arm` called `move_to_pose`:
```py
