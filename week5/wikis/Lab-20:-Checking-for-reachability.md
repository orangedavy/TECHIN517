...
# Check the plan
Look at the documentation for [MoveItGoalBuilder](https://github.com/cse481wi19/cse481wi19/blob/indigo-devel/robot_api/src/robot_api/moveit_goal_builder.py).
